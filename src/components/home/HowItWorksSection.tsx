...
export default function HowItWorksSection() {
  return (
    <AnimatedSection
      id="how-it-works"
      className="bg-gradient-to-b from-slate-900 to-slate-950 px-4 py-8 sm:py-16 sm:px-6 lg:px-8"
    >
      <div className="mx-auto w-full max-w-5xl">
        ...
        <h2 className="stagger-child stagger-0 mb-6 text-center text-xl font-bold text-white sm:mb-10 sm:text-2xl md:text-3xl">
